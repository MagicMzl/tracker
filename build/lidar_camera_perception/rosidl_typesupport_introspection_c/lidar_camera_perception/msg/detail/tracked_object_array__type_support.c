...
#include <stddef.h>
#include "lidar_camera_perception/msg/detail/tracked_object_array__rosidl_typesupport_introspection_c.h"
...
// Member `objects`
#include "lidar_camera_perception/msg/tracked_object.h"
// Member `objects`
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  lidar_camera_perception__msg__TrackedObjectArray__init(message_memory);
}

void TrackedObjectArray__rosidl_typesupport_introspection_c__TrackedObjectArray_fini_function(void * message_memory)
{
  lidar_camera_perception__msg__TrackedObjectArray__fini(message_memory);
}

size_t TrackedObjectArray__rosidl_typesupport_introspection_c__size_function__TrackedObject__objects(
  const void * untyped_member)
{
  const lidar_camera_perception__msg__TrackedObject__Sequence * member =
    (const lidar_camera_perception__msg__TrackedObject__Sequence *)(untyped_member);
  return member->size;
}

const void * TrackedObjectArray__rosidl_typesupport_introspection_c__get_const_function__TrackedObject__objects(
...
void * TrackedObjectArray__rosidl_typesupport_introspection_c__get_function__TrackedObject__objects(
  void * untyped_member, size_t index)
{
  lidar_camera_perception__msg__TrackedObject__Sequence * member =
    (lidar_camera_perception__msg__TrackedObject__Sequence *)(untyped_member);
  return &member->data[index];
}

bool TrackedObjectArray__rosidl_typesupport_introspection_c__resize_function__TrackedObject__objects(
  void * untyped_member, size_t size)
{
  lidar_camera_perception__msg__TrackedObject__Sequence * member =
    (lidar_camera_perception__msg__TrackedObject__Sequence *)(untyped_member);
  lidar_camera_perception__msg__TrackedObject__Sequence__fini(member);
  return lidar_camera_perception__msg__TrackedObject__Sequence__init(member, size);
}
...
static rosidl_typesupport_introspection_c__MessageMember TrackedObjectArray__rosidl_typesupport_introspection_c__TrackedObjectArray_message_member_array[2] = {
  {
    ...
    offsetof(lidar_camera_perception__msg__TrackedObjectArray, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(lidar_camera_perception__msg__TrackedObjectArray, objects),  // bytes offset in struct
    NULL,  // default value
    TrackedObjectArray__rosidl_typesupport_introspection_c__size_function__TrackedObject__objects,  // size() function pointer
    TrackedObjectArray__rosidl_typesupport_introspection_c__get_const_function__TrackedObject__objects,  // get_const(index) function pointer
    TrackedObjectArray__rosidl_typesupport_introspection_c__get_function__TrackedObject__objects,  // get(index) function pointer
    TrackedObjectArray__rosidl_typesupport_introspection_c__resize_function__TrackedObject__objects  // resize(index) function pointer
  }
};
...
static const rosidl_typesupport_introspection_c__MessageMembers TrackedObjectArray__rosidl_typesupport_introspection_c__TrackedObjectArray_message_members = {
  ...
  2,  // number of fields
  sizeof(lidar_camera_perception__msg__TrackedObjectArray),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_camera_perception, msg, TrackedObjectArray)() {
