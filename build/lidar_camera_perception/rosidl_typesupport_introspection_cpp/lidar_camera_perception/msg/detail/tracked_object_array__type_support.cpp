...
{
  new (message_memory) lidar_camera_perception::msg::TrackedObjectArray(_init);
}

void TrackedObjectArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lidar_camera_perception::msg::TrackedObjectArray *>(message_memory);
  typed_message->~TrackedObjectArray();
}

size_t size_function__TrackedObjectArray__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<lidar_camera_perception::msg::TrackedObject> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<lidar_camera_perception::msg::TrackedObject> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<lidar_camera_perception::msg::TrackedObject> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrackedObjectArray_message_member_array[2] = {
  {
    ...
    offsetof(lidar_camera_perception::msg::TrackedObjectArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<lidar_camera_perception::msg::TrackedObject>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(lidar_camera_perception::msg::TrackedObjectArray, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrackedObjectArray_message_members = {
  ...
  2,  // number of fields
  sizeof(lidar_camera_perception::msg::TrackedObjectArray),
...
{
  return &::lidar_camera_perception::msg::rosidl_typesupport_introspection_cpp::TrackedObjectArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lidar_camera_perception, msg, TrackedObjectArray)() {
  return &::lidar_camera_perception::msg::rosidl_typesupport_introspection_cpp::TrackedObjectArray_message_type_support_handle;
}
