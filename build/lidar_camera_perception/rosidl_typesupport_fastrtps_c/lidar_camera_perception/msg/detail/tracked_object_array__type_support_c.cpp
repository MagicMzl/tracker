...
#include "lidar_camera_perception/msg/detail/tracked_object_array__rosidl_typesupport_fastrtps_c.h"
...
#include "lidar_camera_perception/msg/detail/tracked_object__functions.h"  // objects
...
using _TrackedObjectArray__ros_msg_type = lidar_camera_perception__msg__TrackedObjectArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: objects
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, lidar_camera_perception, msg, TrackedObject
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: objects
  {
    ...
    if (ros_message->objects.data) {
      lidar_camera_perception__msg__TrackedObject__Sequence__fini(&ros_message->objects);
    }
...
size_t get_serialized_size_lidar_camera_perception__msg__TrackedObjectArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrackedObjectArray__ros_msg_type * ros_message = static_cast<const _TrackedObjectArray__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_lidar_camera_perception__msg__TrackedObject(
...
static uint32_t _TrackedObjectArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lidar_camera_perception__msg__TrackedObjectArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lidar_camera_perception
size_t max_serialized_size_lidar_camera_perception__msg__TrackedObjectArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_lidar_camera_perception__msg__TrackedObject(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_lidar_camera_perception__msg__TrackedObjectArray(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_camera_perception, msg, TrackedObjectArray)() {
