...
#include "lidar_camera_perception/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _TrackedObjectArray_type_support_symbol_names_t _TrackedObjectArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_camera_perception, msg, TrackedObjectArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_camera_perception, msg, TrackedObjectArray)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_lidar_camera_perception
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidar_camera_perception, msg, TrackedObjectArray)() {
  return &::lidar_camera_perception::msg::rosidl_typesupport_c::TrackedObjectArray_message_type_support_handle;
}
