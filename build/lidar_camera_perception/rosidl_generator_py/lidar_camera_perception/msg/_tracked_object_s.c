...
bool lidar_camera_perception__msg__tracked_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lidar_camera_perception.msg._tracked_object.TrackedObject", full_classname_dest, 57) == 0);
  }
  lidar_camera_perception__msg__TrackedObject * ros_message = _ros_message;
  {  // header
...
PyObject * lidar_camera_perception__msg__tracked_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lidar_camera_perception.msg._tracked_object");
